...
export const posts = [
 ...
 {heading:"Keep the pair together",paragraphs:["After a generation completes, download both the MP4 and its JSON receipt. The studio holds results in memory for the current session. Closing or refreshing the page clears that session.","A clear origin makes creative work easier to audit and discuss. It is one part of a trustworthy workflow, alongside honest model documentation, well-understood infrastructure, and careful handling of the creator’s device."]}]},
 ...additionalPosts,
];
