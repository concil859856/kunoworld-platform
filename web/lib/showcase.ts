 ...
 * Everything here was rendered through OpenRouter with Wan 3.0, Seedance 2.0 or MiniMax H3 (the
 * weights the network serves, but not on a sealed stage). None of it was made on the KunoWorld
 * network. Only a certificate-backed network film may use source "kuno".
 */
...
/**
 * One sample per creation-mode tab. Image to video and first & last frame were rendered by Seedance
 * from the stills in `inputs`, and References by MiniMax H3 from its three reference stills. Nothing
 * here can take three keyframes, and OpenRouter takes a source video only by HTTPS URL, so the
 * Keyframes and Edit tabs show stand-ins and say so in `note`.
 */
export const modeClips: Record<CreationModeId, SampleClip> = {
  ...
  image: { ...SEEDANCE, id: "tab-image", title: "Harbour at dawn", category: "Image to video", src: "/media/tab-image.mp4", poster: "/media/tab-image-poster.webp", aspect: "16:9", alt: "A still harbour at dawn comes alive as a boat eases away from the quay.", inputs: [{ src: "/stills/in-first-frame.jpg", role: "First frame", alt: "A still harbour at dawn, boats at their moorings, mist on the water." }] },
  "first-last": { ...SEEDANCE, id: "tab-first-last", title: "The storm comes in", category: "First & last frame", src: "/media/tab-first-last.mp4", poster: "/media/tab-first-last-poster.webp", aspect: "16:9", alt: "A storm rolls across a beach, from calm water to rain sweeping the sand.", inputs: [{ src: "/stills/in-keyframe-1.jpg", role: "First frame", alt: "An empty beach under a calm pale sky." }, { src: "/stills/in-keyframe-3.jpg", role: "Last frame", alt: "The same beach in heavy rain sweeping across the sand." }] },
  keyframes: { ...SEEDANCE, id: "tab-keyframes", title: "A storm in three beats", category: "Keyframes", src: "/media/tab-keyframes.mp4", poster: "/media/tab-keyframes-poster.webp", aspect: "16:9", alt: "A storm builds over a beach in three beats: calm shallow water, wind in the dune grass, then rain sweeping over the dunes.", note: "Text-prompted stand-in: the sample model can’t take keyframes" },
  references: { ...H3, id: "tab-references", title: "Spray on the pier", category: "References", src: "/media/tab-references.mp4", poster: "/media/tab-references-poster.webp", aspect: "16:9", alt: "A woman in a yellow raincoat carries a brass lantern along a stone pier as spray bursts over the wall.", inputs: [{ src: "/stills/in-reference-cast.jpg", role: "Cast", alt: "A woman in her fifties in a yellow oilskin raincoat." }, { src: "/stills/in-reference-place.jpg", role: "Location", alt: "A stone harbour pier with iron bollards and a low sea wall." }, { src: "/stills/in-reference-prop.jpg", role: "Prop", alt: "A brass paraffin storm lantern." }] },
  edit: { ...SEEDANCE, id: "tab-edit", title: "Snow on the coast road", category: "Edit & retake", src: "/media/tab-edit.mp4", poster: "/media/tab-edit-poster.webp", aspect: "16:9", alt: "A coast road in flat daylight turns to snowfall on the same forward camera move, snow settling on the stone walls.", inputs: [{ src: "/stills/in-source-still.jpg", role: "First frame", alt: "A quiet coast road in flat daylight between low stone walls." }], note: "Stand-in: rendered from a still of the road and a text prompt, not an edit of an existing clip" },
};
