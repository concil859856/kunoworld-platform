...
export function AmbientVideo({src,poster,className="",label="Pause background video",alt=""}:{src:string;poster:string;className?:string;label?:string;alt?:string}) {
